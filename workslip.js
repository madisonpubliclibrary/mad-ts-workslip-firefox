(function(){
  ...
  const holds = document.querySelector('td.holds');
  const titleTH = document.querySelector('th.title');
  const title = document.querySelector('td.title');
  const authorTH = document.querySelector('th.author');
  const author = document.querySelector('td.author');
  const bibRecId = document.querySelector('td.bibRecId');
  const marc300 = document.querySelector('td.marc300');
  const ean13 = document.querySelector('td.ean13');
  const marc001 = document.querySelector('td.marc001');
  const marc092 = document.querySelector('td.marc092');
  const marc099a = document.querySelector('td.marc099a');
  const isbn = document.querySelector('td.isbn');
  const isbnMARC = document.querySelector('td.isbnMARC');
  const upc024a = document.querySelector('td.upc024a');
  const issn = document.querySelector('td.issn');
  const ismn = document.querySelector('td.ismn');
  const upc = document.querySelector('td.upc');
  const manufactNum = document.querySelector('td.manufactNum');
  const supplierNum = document.querySelector('td.supplierNum');
  ...
  const edition = document.querySelector('td.edition');
  const getitDescription = document.querySelector('td.getitDescription');
  const rush = document.getElementById('rush');
  const getitCopies = document.getElementById('getitCopies');
  const linkCopies = document.getElementById('linkCopies');
